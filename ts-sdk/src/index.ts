...
export const ON_DEMAND_MAINNET_ADDRESS =
  "0xfea54925b5ac1912331e2e62049849b37842efaea298118b66f85a59057752b8";
export const ON_DEMAND_MAINNET_QUEUE =
  "0x7fdf7235bf3bd872ad093927deb2ff5f1645d1b6dabbfd4a03c3e0442788ce12";
export const ON_DEMAND_MAINNET_GUARDIAN_QUEUE =
  "0x3434a45114f5f8fc577557a9a3dda54c1799fee5271313f2599a1093c4a8ba01";

export const ON_DEMAND_TESTNET_ADDRESS =
  "0x4fc1809ffb3c5ada6b4e885d4dbdbeb70cbdd99cbc0c8485965d95c2eab90935";
export const ON_DEMAND_TESTNET_QUEUE =
  "0xe898232691709ed4f47827a100aac2ca8ea5b27692b5d694b00cb4b2c714e760";
export const ON_DEMAND_TESTNET_GUARDIAN_QUEUE =
  "0x17ce931b15d5c4ca8f8e6a5b6b84e2aee44002e5fc5cb4cf00817bb462b56c4a";

export const ON_DEMAND_MOVEMENT_PORTO_ADDRESS =
  "0xfa416028d48a85cd7791c8a93c438ce8a750af333a53fde55b276fd4aa16275f";
export const ON_DEMAND_MOVEMENT_PORTO_QUEUE =
  "0x4e445d2968329979b34df2606a65e962ad15a540885fdcbb19eaf7a2a5bf4a22";
export const ON_DEMAND_MOVEMENT_PORTO_GUARDIAN_QUEUE =
  ...
  async fetchState(
    ...
    try {
      if (Network.MAINNET === this.aptos.config.network && isAptos) {
        return {
          switchboardAddress:
            options?.switchboardAddress ?? ON_DEMAND_MAINNET_ADDRESS,
          guardianQueue:
            options?.guardianQueue ?? ON_DEMAND_MAINNET_GUARDIAN_QUEUE,
        ...
        return {
          switchboardAddress:
            options?.switchboardAddress ?? ON_DEMAND_TESTNET_ADDRESS,
          guardianQueue:
            options?.guardianQueue ?? ON_DEMAND_TESTNET_GUARDIAN_QUEUE,
        ...
        return {
          switchboardAddress:
            options?.switchboardAddress ?? ON_DEMAND_MOVEMENT_PORTO_ADDRESS,
          guardianQueue:
            options?.guardianQueue ?? ON_DEMAND_MOVEMENT_PORTO_GUARDIAN_QUEUE,
...
export function hexToB58(hex: string): string {
  ...
  return bs58.encode(new Uint8Array(Buffer.from(hexStr, "hex")));
}
